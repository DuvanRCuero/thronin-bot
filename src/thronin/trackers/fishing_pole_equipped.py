...
class FishingPoleEquipped(Tracker):
    WINDOW_CONFIGS = {
        720: {
            "tolerance": 15,
            "xywh": (569, 654, 1, 1),
            "target_color": np.array([84, 100, 124]),
            "fishing_rod_button_circle": (554, 644, 27, 27),
        },
        1080: {
            "tolerance": 15,
            "xywh": (835, 965, 1, 1),
            "target_color": np.array([84, 100, 124]),
            "fishing_rod_button_circle": (811, 948, 45, 45),
        },
    }

    def __init__(self):
        super().__init__("fishing_pole_equipped")
    ...
    def analyze_screenshot(self, screenshot):
        ...
        x, y, w, h = config.get("fishing_rod_button_circle")
        shape_data.append(
            {
                "type": "circle",
                "key": "fishing_rod_button_circle",  # update key name
                "config": {
                    "x1": x,
                    "y1": y,
                    "x2": x + w,
...
fishing_pole_equipped = FishingPoleEquipped()
