...
class DaybreakShoreRoutine(Routine):
    def __init__(self):
        super().__init__("daybreak_shore")
        self._required_trackers = []
        self.pretty_name = "Daybreak Shore"
        self.search_name = "daybreak"
        self.map_tp_coords = {
            720: [815, 265],
            1080: [1268, 374],
        }
...
daybreak_shore = DaybreakShoreRoutine()
